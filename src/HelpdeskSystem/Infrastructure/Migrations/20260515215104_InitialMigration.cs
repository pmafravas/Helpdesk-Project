        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UltimaAtividade = table.Column<DateTime>(type: "datetime", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Chamados_Users_ResponsavelId",
                        column: x => x.ResponsavelId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Chamados_Users_SolicitanteId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MensagemId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ChamadoAssociado = table.Column<int>(type: "int", nullable: false),
                    ConteudoMensagem = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DataCriacao = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UsuarioDono = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Mensagens_Chamados_ChamadoAssociado",
                        column: x => x.ChamadoAssociado,
                        principalTable: "Chamados",
                        principalColumn: "ChamadoId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Mensagens_Users_UsuarioDono",
                        column: x => x.UsuarioDono,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                })
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Mensagens_ChamadoAssociado",
                table: "Mensagens",
                column: "ChamadoAssociado");

            migrationBuilder.CreateIndex(
                name: "IX_Mensagens_UsuarioDono",
                table: "Mensagens",
                column: "UsuarioDono");
